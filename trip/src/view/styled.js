...
const Main = Styled.div`
    ...
    .card-grid-wrap{
        .ant-card-grid{
            box-shadow: 1px 0 0 0 ${({ theme }) => theme[theme.mainContent]["border-color-default"]}30, 0 1px 0 0 ${({ theme }) => theme[theme.mainContent]["border-color-default"]}, 1px 1px 0 0 ${({
  theme,
}) => theme[theme.mainContent]["border-color-default"]}, 1px 0 0 0 ${({ theme }) => theme[theme.mainContent]["border-color-default"]} inset, 0 1px 0 0 ${({ theme }) =>
