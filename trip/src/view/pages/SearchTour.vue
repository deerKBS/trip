    ...
    <div class="bg-sky-50 shadow-lg" :class="isToggleC">
      <div class="row">
        <div class="col-md-auto" style="margin-top: 50px">
          ...
          <div></div>
          <div>
            <button type="button" class="btn custom-btn" style="width: 180px" @click="getList()">
              검 색
            </button>
          </div>
        </div>
...
export default {
  ...
  computed: {
    buttonGroupClass() {
      return this.innerWidth < 1100 ? "half_button_group" : "full_button_group";
    },
    mapClass() {
      return this.innerWidth < 1100 ? "half_map" : "full_map";
    },
    shouldFloatRight() {
      return this.innerWidth < 1100 ? "float-right" : "";
    },
    isToggleP() {
  ...
  methods: {
    ...
    async getCat3List() {
      let url = "/trip/categoryCode";
      let urlParams =
        "?numOfRows=30" + "&pageNo=" + this.pageNo + "&cat1=" + this.cat1 + "&cat2=" + this.cat2;
