  ...
  <div style="margin: auto; width: 80%">
    <div class="container w-full">
      ...
      <div class="row justify-content-between" style="min-width: 100%">
        <div class="dropdown col-2">
          <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">{{ board.categoryName }}</button>
    ...
    <div>
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="titleUpdate" v-model="board.title" />
      </div>
      <div class="mb-3">
      ...
      <button @click="boardUpdate" class="btn btn-primary float-end custom-btn" type="button">수정</button>
